...
public class CreateFormServiceImpl implements CreateFormService {
    ...
    @Autowired
    private CreateFormRepo createFormRepo;

    @Override
    public CreateForm findByFormName(String formName) {
        return createFormRepo.findByActiveAndFormName(Boolean.TRUE, formName);
    }

    @Override
    public CreateForm findByCompanyName(String organization) {
        return createFormRepo.findByActiveAndCompanyName(Boolean.TRUE, organization);
    }

    @Override
    public List<CreateForm> getAll() {
        return createFormRepo.findByActive(Boolean.TRUE);
    }

    @Override
    public CreateForm get(String id) {
        return createFormRepo.findById(id).get();
    }
...
//        t.setModifiedBy(getCurrentUser());
    ...
    public List<CreateForm> findByActiveAndDateModified(Boolean active, Date date) {
        return createFormRepo.findByActiveAndDateModified(active, date);
    }

    @Override
    public List<CreateForm> findByActiveAndDateCreated(Boolean active, Date date) {
        return createFormRepo.findByActiveAndDateCreated(active, date);
    }
